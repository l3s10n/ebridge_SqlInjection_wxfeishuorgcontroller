...
response = requests.post(f'{url}/main/feishu/org/saveUser?sysappid={sysAppId}', cookies=cookies, headers=headers, data=data)
...
# response = requests.post(f'{url}/main/feishu/org/exportOrg?syscorpid=123456&sysappid={sysAppId}', cookies=cookies, headers=headers, data=data)
